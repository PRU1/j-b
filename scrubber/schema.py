...
ASSESSMENT = obj(verdict=VERDICT, reason=STRING)
SEMANTIC_REVIEW = obj(
    text=STRING,
    assertions=arr(obj(span=STRING, evidence=arr(EVIDENCE, 0),
                       verdict=VERDICT, reason=STRING)),
    support=ASSESSMENT,
    relevance=arr(obj(requirement=STRING, verdict=VERDICT, reason=STRING)))
